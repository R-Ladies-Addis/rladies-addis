...
If anything in these instructions doesn't work or doesn't make sense, open an issue [here](https://github.com/r-ladies-addis/rladies-addis/issues) or email mesfin.diro@aau.edu.et.
